...
@section('content')
    <div class="content">
        <form method="POST" action="{{ route('agentadmin.vendor_sources.update', $user->id) }}" @submit.prevent="onSubmit">
            <div class="page-header">
                <div class="page-title">
                    <h1>
                        <i class="icon angle-left-icon back-link" onclick="history.length > 1 ? history.go(-1) : window.location = '{{ url('/agentadmin/dashboard') }}';"></i>
