...
namespace Highwayns\MerchantAdmin\Exceptions;
...
class Handler extends ExceptionHandler
{
    ...
    {
        $path = $this->isAdminUri() ? 'agentadmin' : 'shop';
    ...
    {
        return strpos(\Illuminate\Support\Facades\Request::path(), 'agentadmin') !== false ? true : false;
    }
