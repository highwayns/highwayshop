@extends('merchantadmin::layouts.content')
...
@section('content')
    <div class="content">
        <form method="POST" action="{{ route('merchantadmin.catalog.families.update', $attributeFamily->id) }}" @submit.prevent="onSubmit">
...
@push('scripts')
    ...
    <script type="text/x-template" id="group-form-template">
        <form method="POST" action="{{ route('merchantadmin.catalog.families.store') }}" data-vv-scope="add-group-form" @submit.prevent="addGroup('add-group-form')">
