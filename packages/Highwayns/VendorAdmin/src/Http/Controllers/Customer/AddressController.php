    ...
    */
    ...
    public function store()
    {
       request()->merge(['address1' => implode(PHP_EOL, array_filter(request()->input('address1')))]);
        ...
        if ( $this->customerAddress->create($data) ) {
            ...
            return redirect()->route('vendoradmin.customer.addresses.index', ['id' => $data['customer_id']]);
        } else {
    ...
    public function update($id)
    {
        ...
        if ( $address ) {
            ...
            return redirect()->route('vendoradmin.customer.addresses.index', ['id' => $address->customer_id]);
        }
