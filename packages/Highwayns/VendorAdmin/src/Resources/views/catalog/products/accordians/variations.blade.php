...
@push('scripts')
    ...
    <script type="text/x-template" id="variant-form-template">
        <form method="POST" action="{{ route('vendoradmin.catalog.products.store') }}" data-vv-scope="add-variant-form" @submit.prevent="addVariant('add-variant-form')">
    ...
    <script type="text/x-template" id="variant-item-template">
        <tr>
            ...
            <td class="actions">
                <a :href="['{{ route('vendoradmin.catalog.products.index') }}/edit/' + variant.id]"><i class="icon pencil-lg-icon"></i></a>
