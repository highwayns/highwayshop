...
return [
    ...
    'settings' => [
        ...
        'vendor_sources' => [
            ...
            'status-and-role' => 'Status＆Role',
            'role' => 'Role',
            'status' => 'Status',
            'account-is-active' => 'Account is active',
            'name_kana' => 'Kana',
            'creditcard_main_apikey' => 'Creditcard main apikey',
            'creditcard_denki_apikey' => 'Credutcard denki apikey',
            'account_transfer_company_code' => 'Company code',
            'smartcis_my_auth_id' => ' SmartCIS auth ID',
            'smartcis_my_auth_key' => 'SmartCIS auth Key',
            'vendor_denki_shop_code' => 'Vendor Denki Shop Code',
            'updated_at' => 'Updated Time',
            'updated_user_id' => 'Updated User ID',
            'created_at' => 'Created Time',
            'created_user_id' => 'Created User Id',
            'gmo_main_site_id' => 'gmo Site ID',
            'gmo_main_site_pass' => 'gmo Site Pass',
            'gmo_main_shop_id' => 'gmo main shop ID',
            'gmo_main_shop_pass' => 'gmo main shop pass',
            'gmo_denki_site_id' => 'gmo denki site ID',
            'gmo_denki_site_pass' => 'gmo denki site pass',
            'gmo_denki_shop_id' => 'gmodenki shop ID',
            'gmo_denki_shop_pass' => 'gmo denki shop pass',
            'aplus_bank_consignor_number' => 'aplus bank consignor number',
            'aplus_division' => 'aplus division',
            'aplus_conveni_consignor_number' => 'aplus conveni consignor number',
            'aplus_transfer_date' => 'aplus transfer date',
            'create-success' => 'Create Success.',
            'update-success' => 'Update Success.',
            'delete-success' => 'Delete Success.',
            'last-delete-error' => 'Last record can not be deleted.',
        ],
        'agent_sources' => [
            'title' => 'Agent',
            'add-title' => 'Add',
            ...
            'tel' => 'Tel',
            'fax' => 'FAX',
            'agency_denki_shop_code' => 'SmartCIS Agent ID',
            'created_at' => 'Create Time',
            'created_user_id' => 'Create User ID',
            'updated_at' => 'Update Time',
            'updated_user_id' => 'Update User ID',
            'create-success' => 'Create Success.',
            'update-success' => 'Update Sucess.',
            'delete-success' => 'Delete Success.',
            'last-delete-error' => 'Last Agent can not be Deleted.',
        ],
        'channels' => [
            'title' => 'Channels',
