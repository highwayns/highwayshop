@extends('agentadmin::layouts.anonymous-master')
    ...
    <div class="panel">
        ...
        <div class="panel-content">
            ...
            <div class="form-container" style="text-align: left">
                ...
                <form method="POST" action="{{ route('agentadmin.session.store') }}" @submit.prevent="onSubmit">
                    @csrf
                    ...
                    <div class="control-group">
                        <a href="{{ route('agentadmin.forget-password.create') }}">{{ __('admin::app.users.sessions.forget-password-link-title') }}</a>
                    </div>
