        ...
        Vue.component('downloadable-link-item', {
            ...
            methods: {
                ...
                uploadFile: function(type) {
                    ...
                    this.$http.post("{{ route('vendoradmin.catalog.products.upload_link', $product->id) }}", formData, { headers: { 'Content-Type': 'multipart/form-data' } })
        ...
        Vue.component('downloadable-sample-item', {
            ...
            methods: {
                ...
                uploadFile: function(type) {
                    ...
                    this.$http.post("{{ route('vendoradmin.catalog.products.upload_sample', $product->id) }}", formData, { headers: { 'Content-Type': 'multipart/form-data' } })
                        .then(function(response) {
